...
def main():
    ...
    train_dataset = v_dataset.trainset1+v_dataset.trainset21+v_dataset.trainset22+v_dataset.trainset23+v_dataset.trainset3
    train_sampler = None
    ...
    if train_sampler:
        ...
        train_data_loader = torch.utils.data.DataLoader(train_dataset,
                                                        ...
                                                        pin_memory=True,
                                                        num_workers=nw,
                                                        collate_fn=v_dataset.trainset1.collate_fn)
    else:
        train_data_loader = torch.utils.data.DataLoader(train_dataset,
    ...
    torch.save(save_files, "pth/object_foot.pth".format(epoch),_use_new_zipfile_serialization=True)
