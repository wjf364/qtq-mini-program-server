...
def main():
    ...
    train_dataset = z_dataset.trainset1+z_dataset.trainset21+z_dataset.trainset22+z_dataset.trainset23+z_dataset.trainset3
    train_sampler = None
    ...
    if train_sampler:
        ...
        train_data_loader = torch.utils.data.DataLoader(train_dataset,
                                                        ...
                                                        pin_memory=True,
                                                        num_workers=nw,
                                                        collate_fn=z_dataset.trainset1.collate_fn)
    else:
        train_data_loader = torch.utils.data.DataLoader(train_dataset,
    ...
    torch.save(save_files, "pth/object_ear.pth".format(epoch),_use_new_zipfile_serialization=True)
