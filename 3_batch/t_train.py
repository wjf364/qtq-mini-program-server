...
from t_dataset import traindata,testdata,test_delete_bg,test_have_bg
...
def training(trainloader, testloader=None,  testloader_remove_bg=None,testloader_have_bg=None):
    ...
    for epoch in range(25):
        ...
        for i,data in tqdm(enumerate(trainloader)):
            ...
            outputs,outputs_shape = net(inputs.cuda())
...
def testing(dataloader, network, which_set):
    ...
    with torch.no_grad():
        for data in tqdm(dataloader):
            ...
            outputs,outputs_shape = network(inputs.cuda())
...
if __name__ == '__main__':
    ...
    trainloader=t_dataset.trainloader
    for i, data in tqdm(enumerate(trainloader)):
        img,label_age=data
    ...
    testloader=t_dataset.testloader
    test_delete_bg=t_dataset.test_delete_bg
    test_have_bg=t_dataset.test_have_bg
