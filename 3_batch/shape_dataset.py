...
import numpy as np
from shape_dataloader import BronzeWareDataset, new_BronzeWareDataset, load_age_table1, load_age_table2, load_age_table3, \
    new3_BronzeWareDataset
from shape_setting import age_idx1, create_dataset, div_dataset
